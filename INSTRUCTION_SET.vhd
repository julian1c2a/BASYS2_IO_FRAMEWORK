...
PACKAGE INSTRUCTION_SET IS
    ...
    CONSTANT C_OP_AND      : STD_LOGIC_VECTOR(3 DOWNTO 0) := "0100";
    CONSTANT C_OP_OR       : STD_LOGIC_VECTOR(3 DOWNTO 0) := "0101";
    CONSTANT C_OP_XOR      : STD_LOGIC_VECTOR(3 DOWNTO 0) := "0110";
    CONSTANT C_OP_NOT      : STD_LOGIC_VECTOR(3 DOWNTO 0) := "0111";
    ...
    CONSTANT C_OP_A_PLUS_B : STD_LOGIC_VECTOR(3 DOWNTO 0) := "1011";
    CONSTANT C_OP_MAX      : STD_LOGIC_VECTOR(3 DOWNTO 0) := "1100";
    CONSTANT C_OP_MIN      : STD_LOGIC_VECTOR(3 DOWNTO 0) := "1101";
